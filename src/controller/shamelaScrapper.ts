...
export class ShamelaScraperController {
    async scrape(req: Request, res: Response): Promise<any> {
        try {
            ...
            pythonProcess.on('close', async (code) => {
                ...
                try {
                    ...
                    const combinedFilePath = parsedData.output_doc; 
    ...
    async getScrapedDocuments(req: Request, res: Response): Promise<any> {
        try {
    ...
    async getScrapedDocumentById(req: Request, res: Response): Promise<any> {
        try {
